...
### 全因子交叉：旋钮 1 × 旋钮 2a × 旋钮 2b × 旋钮 3

所有旋钮取值做完全交叉，不做降维或代表性子集采样。
...
总计: 114,432 × 100 = 11,443,200 个散点图
```
...
| 旋钮 | 因子 | 水平数 | 取值 |
|------|------|--------|------|
| 旋钮 1 | 函数配置 | 298 | F01–F22 + Null 全部参数变体 |
| 旋钮 2a | SNR | 12 | 0.1, 0.3, 0.5, 1, 2, 3, 5, 10, 20, 50, 100, ∞ |
...
```
298 × 12 × 4 × 8 = 114,432 case
× 100 repeats   = 11,443,200 个散点图
```
